...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        self.tiles = [[dirt_amount for i in range(height)] for j in range(width)]
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        capacity: the amount of dirt to be cleaned in a single time-stereturn ()
                  can be negative which would mean adding dirt to the tile

        Note: The amount of dirt on each tile should be NON-NEGATIVE.
              If the capacity exceeds the amount of dirt on the tile, mark it as 0.
        """
        m, n = int(pos.get_x()), int(pos.get_y())
        new_dirt_amount = max(0, self.tiles[m][n]-capacity)
        self.tiles[m][n] = new_dirt_amount
        return
    ...
    def get_num_cleaned_tiles(self):
        ...
        """
        return sum([self.is_tile_cleaned(m,n) for m in range(self.width)
    ...
    def is_position_in_room(self, pos):
        ...
        """
        return (pos.get_x() >= 0 and pos.get_x() < self.width and
...
# === Problem 5
def run_sim_trial(room, robots, min_coverage):
    time_steps = 0
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for _ in range(num_trials):
        ...
        total_time += run_sim_trial(room, robots, min_coverage)
